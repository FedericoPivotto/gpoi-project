 ...
 * -> Script PHP per aggiungere nuove manutenzioni ordinarie al database
 * 
*/
...
// Aggiunta dati a tabella storicomanutenzione_ordinaria
function aggiungiManutenzioneOrd()
{
	global $connection;
    ...
    if(checkNumeroInventario($numeroInventario))
    {
	    ...
	    if(!checkManutenzioneOrdDoppia($dataManutenzione, $azione, $idInventario))
	    {
	        //query di inserimento
	        $table = "storicomanutenzione_ordinaria";
...
function checkManutenzioneOrdDoppia($dataManutenzione, $azione, $idInventario)
{
    global $connection;
