...
<html>
	...
	<body>
        ...
        <div class="container">
    		<h2 class="titoloSezione text-center" id="mostra-tabella-utenti">Modifica quantit&agrave; dell'elemento</h2>
            <form autocomplete="off" method="POST" action="api/modificaquantitavetreria.php">
                <?php 
                    echo "<input type=\"hidden\" name=\"idVetreria\" value=\"".$_GET['idVetreria']."\">";
