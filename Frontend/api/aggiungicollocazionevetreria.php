 ...
 * -> Script PHP per aggiungere nuove collocazioni vetreria al database
 * 
*/
...
function aggiungiCollocazioneVetreria()
{
    global $connection;
    global $idVetreria;
    ...
    if(!checkQuantitaVA($idVetreria, $idR))
    {
        // inserimento tupla in molti a molti
        $queryFk = "INSERT INTO quantitava (idVA, idRipiano, quantita, dataVerifica, dataScadenza) VALUES ('$idVetreria', '$idR', '$quantita', '$dataVerifica', '$dataScadenza');";
...
function checkQuantitaVA($idVetreria, $idRipiano)
{
    global $connection;

    $query = "SELECT * FROM quantitava 
                WHERE idVA = '$idVetreria' AND idRipiano = '$idRipiano';";
