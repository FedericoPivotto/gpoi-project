...
<html>
	...
	<body>
        ...
        <div class="container">
    		<h2 class="titoloSezione text-center" id="mostra-tabella-utenti">Modifica quantit&agrave; del manuale delle istruzioni</h2>
            <form autocomplete="off" method="post" action="api/modificaquantitamanuale.php">
                <?php 
                    ...
                    echo "<input type=\"hidden\" name=\"idManuale\" value=\"".$_GET['idManuale']."\">";
