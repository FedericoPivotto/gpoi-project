...
<html>
	...
	<body>
        ...
        <div class="container">
    		<h2 class="titoloSezione text-center" id="mostra-tabella-utenti">Modifica quantit&agrave; del reagente</h2>
            <form autocomplete="off" method="POST" action="api/modificaquantitareagente.php">
				<?php 
                ...
                <div style="text-align:center;" >
    				<div class="form-group">
                        ...
                        <input type="text" class="form-control" id="quantita" name="quantita" required="true">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Data verifica</label>
                        <input type="date" class="form-control" id="dataVerifica" name="dataVerifica" required="true">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Data scadenza</label>
                        <input type="date" class="form-control" id="dataScadenza" name="dataScadenza" required="true">
                    </div>
