...
--
-- Host: 127.0.0.1
-- Creato il: Mag 04, 2020 alle 21:17
...
(65, 'admin_01', 'b2cdd380947330cab613d974492b8e26', 1),
(67, 'studente_02', '8d5ea2cbcbd5dcbec9f717c767834333', 2),
(69, 'itp_03', 'f6ebf43f91e0a6fac8d27bb7dfea19a2', 3),
(70, 'docente_04', '62f04ac333bda7fb0aa0e3475ca346bd', 4);
...
--
ALTER TABLE `collocazionefisica`
  MODIFY `idCollocazione` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `modalitaconservazione`
  MODIFY `idModalita` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `punto`
  MODIFY `idPunto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT per la tabella `reagente`
--
ALTER TABLE `reagente`
  MODIFY `idReagente` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `ripiano`
  MODIFY `idRipiano` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT per la tabella `schedasicurezza`
--
ALTER TABLE `schedasicurezza`
  MODIFY `idScheda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `utente`
  MODIFY `idUtente` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
